...
the community leaders responsible for enforcement privately via GitHub's
[private reporting channel](https://github.com/Vedant1202/claude-prof/security/advisories/new)
(the repository's _Security_ tab → _Report a vulnerability_, which is the project's
private contact channel). All complaints will be reviewed and investigated promptly and
fairly.
