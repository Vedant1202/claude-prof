...
export const COMMANDS: readonly Command[] = [
  {
    ...
    usage: [
      "Usage: cprof init [--global | --include-global] [--out <dir> | --template <name>]",
      ...
      "  --template <name>  Save the setup as a named template (~/.cprof/templates/<name>)",
  ...
  {
    name: "new",
    synopsis: "new <profile|name> [dir] [--force] | new --list",
    summary: "Scaffold a new project from a profile or named template",
    flags: ["--force", "--list"],
    usage: [
      "Usage: cprof new <profile|name> [dir] [--force]",
      "       cprof new --list",
      "",
      "Scaffold a fresh project from a profile. <profile|name> is either a path to a",
      "claude-profile.json or the name of a template under ~/.cprof/templates/.",
      "Applies the project-scope content into <dir> (the current directory by",
      "default), creating it if needed. Refuses to overwrite anything that already",
      "exists unless --force; a forced overwrite keeps a backup, so `cprof rollback`",
      "can reverse it.",
      "",
      "Options:",
